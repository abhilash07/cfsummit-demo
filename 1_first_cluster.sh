...
#Deploy cluster using Kubo deployment and some cusom opsfiles
...
cat cfcr_ops_files/colocate_errand.yml cfcr_ops_files/add_domain.yml cfcr_ops_files/lb.yml
